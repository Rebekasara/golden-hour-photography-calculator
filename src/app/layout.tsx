...
export const metadata: Metadata = {
  metadataBase: new URL(process.env.NEXTAUTH_URL || "https://goldenhour-calculator.vercel.app"),
  title: {
    default: "Golden Hour Calculator - Professional Photography Lighting Tool",
    template: "%s | Golden Hour Calculator",
  },
  ...
  keywords: [
    ...
    "blue hour photography app",
    "photography lighting calculator free",
    "best photography apps 2025",
    "photography time calculator",
    "sun position photography app",
    "photography lighting assistant free",
    "golden hour tracker app",
    "photography weather app",
    "photography location finder",
    "golden hour quality checker",
    "photography lighting conditions app",
    "photography planning assistant",
    "sun path photography tool",
    "photography lighting predictor",
    "golden hour photography software",
    "blue hour photography planner",
    "photography weather integration app",
    "photography location inspiration",
    "golden hour calculator professional",
    "photography lighting tool free",
    "photography time management app",
    "sun tracking photography app",
    "photography lighting guide app",
    "golden hour photography assistant",
    "photography weather conditions app",
    "photography location scout app",
    "golden hour quality app",
    "photography lighting predictor free",
    "photography planning app professional",
    "sun position calculator app",
    "photography lighting assistant app",
    "golden hour photography tracker",
    "photography weather forecast app",
    "photography location finder app",
    "golden hour photography planner app",
    "blue hour photography calculator app",
    "photography lighting conditions tracker",
    "photography time planning app",
    "sun movement photography app",
    "photography lighting quality app",
    "golden hour photography software free",
    "photography weather assistant app",
    "photography location inspiration app",
    "golden hour photography quality app",
    "photography lighting conditions predictor",
    "photography planning assistant app",
    "sun path photography calculator",
    "photography lighting time app",
    "golden hour photography tracker app",
    "photography weather integration tool",
    "photography location scout tool",
    "golden hour photography predictor app",
    "photography lighting conditions assistant",
    "photography planning software free",
    "sun position photography tracker",
    "photography lighting guide free",
    "golden hour photography assistant app",
    "photography weather conditions tracker",
    "photography location finder tool",
    "golden hour photography planner tool",
    "blue hour photography assistant app",
    "photography lighting conditions calculator",
    "photography time management tool",
    "sun tracking photography software",
    "photography lighting quality predictor",
    "golden hour photography software app",
    "photography weather forecast tool",
    "photography location inspiration tool",
    "golden hour photography quality predictor",
    "photography lighting conditions app free",
    "photography planning assistant tool",
    "sun path photography assistant",
    "photography lighting time calculator",
    "golden hour photography tracker tool",
    "photography weather integration app",
    "photography location scout software",
    "golden hour photography predictor tool",
    "photography lighting conditions guide",
    "photography planning tool professional",
    "sun position photography assistant",
    "photography lighting guide tool",
    "golden hour photography assistant tool",
    "photography weather conditions predictor",
    "photography location finder software",
    "golden hour photography planner software",
    "blue hour photography assistant tool",
    "photography lighting conditions tracker",
    "photography time management software",
    "sun movement photography calculator",
    "photography lighting quality assistant",
    "golden hour photography software tool",
    "photography weather assistant tool",
    "photography location inspiration software",
    "golden hour photography quality assistant",
    "photography lighting conditions predictor app",
    "photography planning assistant software",
    "sun path photography tracker",
    "photography lighting time assistant",
    "golden hour photography tracker software",
    "photography weather integration tool",
    "photography location scout assistant",
    "golden hour photography predictor software",
    "photography lighting conditions guide tool",
    "photography planning software assistant",
    "sun position photography tracker",
    "photography lighting guide assistant",
    "golden hour photography assistant software",
    "photography weather conditions tracker",
    "photography location finder assistant",
    "golden hour photography planner assistant",
    "blue hour photography assistant software",
    "photography lighting conditions calculator app",
    "photography time management assistant",
    "sun tracking photography assistant",
    "photography lighting quality tracker",
    "golden hour photography software assistant",
    "photography weather forecast assistant",
    "photography location inspiration assistant",
    "golden hour photography quality tracker",
    "photography lighting conditions predictor tool",
    "photography planning assistant tracker",
    "sun path photography calculator app",
    "photography lighting time tracker",
    "golden hour photography tracker assistant",
    "photography weather integration software",
    "photography location scout tracker",
    "golden hour photography predictor assistant",
    "photography lighting conditions guide assistant",
    "photography planning tool tracker",
    "sun position photography tracker",
    "photography lighting guide tracker",
    "golden hour photography assistant tracker",
    "photography weather conditions predictor assistant",
    "photography location finder tracker",
    "golden hour photography planner tracker",
    "blue hour photography assistant tracker",
    "photography lighting conditions tracker app",
    "photography time management tracker",
    "sun movement photography assistant",
    "photography lighting quality predictor assistant",
    "golden hour photography software tracker",
    "photography weather assistant tracker",
    "photography location inspiration tracker",
    "golden hour photography quality predictor assistant",
    "photography lighting conditions predictor software",
    "photography planning assistant calculator",
    "sun path photography tracker app",
    "photography lighting time predictor",
    "golden hour photography tracker calculator",
    "photography weather integration assistant",
    "photography location scout calculator",
    "golden hour photography predictor calculator",
    "photography lighting conditions guide calculator",
    "photography planning software calculator",
    "sun position photography calculator",
    "photography lighting guide calculator",
    "golden hour photography assistant calculator",
    "photography weather conditions predictor calculator",
    "photography location finder calculator",
    "golden hour photography planner calculator",
    "blue hour photography assistant calculator",
    "photography lighting conditions predictor calculator",
    "photography time management calculator",
    "sun tracking photography calculator",
    "photography lighting quality calculator",
    "golden hour photography software calculator",
    "photography weather forecast calculator",
    "photography location inspiration calculator",
    "golden hour photography quality calculator",
    "photography lighting conditions predictor calculator",
    "photography planning assistant calculator",
    "sun path photography calculator",
    "photography lighting time calculator",
    "golden hour photography tracker calculator",
    "photography weather integration calculator",
    "photography location scout calculator",
    "golden hour photography predictor calculator",
    "photography lighting conditions guide calculator",
    "photography planning tool calculator",
    "sun position photography calculator",
    "photography lighting guide calculator",
    "golden hour photography assistant calculator",
    "photography weather conditions predictor calculator",
    ...
    "photography lighting quality calculator",
    "golden hour photography software calculator",
    "photography weather assistant calculator",
    "photography location inspiration calculator",
    "golden hour photography quality calculator",
  ],
  ...
  openGraph: {
    ...
    title: "Golden Hour Calculator - Professional Photography Lighting Tool",
    description: "Professional golden hour calculator with real-time weather integration, interactive maps, and authentic location-based photography inspiration. Get precise sunrise, sunset, and blue hour times worldwide.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Golden Hour Calculator - Professional Photography Lighting Tool",
        type: "image/jpeg",
      },
    ],
  },
